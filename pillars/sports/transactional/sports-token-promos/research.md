---
title: "Promo Tokens — Research"
subdomain: discovery
experience-area: promo-tokens
...
Map the Dice design system components (L2) that compose this experience area.
Reference component IDs from `cross-cutting-areas/design-system/component-registry.md`.

| Layer | Component | ID | L3 Customisation Surface |
|-------|-----------|-----|--------------------------|
| Pattern | _Add relevant L2 patterns_ | O.xx | _Tokens / Slots / Delegates_ |
| Compound | _Add relevant L2 compounds_ | C.xx | _Tokens / Slots_ |
| Primitive | _Add relevant L2 primitives_ | P.xx | _Tokens_ |

L3 Assembly Decisions:
- _Which widgets appear on this page/feature?_
- _What slot content does each brand provide?_
- _Which feature flags control presence?_
